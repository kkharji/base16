...
vim.g.terminal_color_7 = "#8b8792"
vim.g.terminal_color_8 = "#655f6d"
...
vim.g.terminal_color_15 = "#efecf4"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#8b8792"
  vim.g.terminal_color_foreground = "#2a9292"
else
  vim.g.terminal_color_background = "#19171c"
...
vim.g.base16_colors = {
  ...
  fg            = '#8b8792',
  fg_gutter     = '#e2dfe7',
  fg_light      = '#efecf4',  -- TODO: this doesn't make sesne
