...
vim.g.terminal_color_0 = "#3C4C55"
vim.g.terminal_color_1 = "#83AFE5"
vim.g.terminal_color_2 = "#7FC1CA"
vim.g.terminal_color_3 = "#A8CE93"
vim.g.terminal_color_4 = "#83AFE5"
vim.g.terminal_color_5 = "#9A93E1"
vim.g.terminal_color_6 = "#F2C38F"
vim.g.terminal_color_7 = "#C5D4DD"
vim.g.terminal_color_8 = "#899BA6"
vim.g.terminal_color_9 = "#83AFE5"
vim.g.terminal_color_10 = "#7FC1CA"
vim.g.terminal_color_11 = "#A8CE93"
vim.g.terminal_color_12 = "#83AFE5"
vim.g.terminal_color_13 = "#9A93E1"
vim.g.terminal_color_14 = "#F2C38F"
vim.g.terminal_color_15 = "#556873"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#C5D4DD"
  vim.g.terminal_color_foreground = "#7FC1CA"
else
  vim.g.terminal_color_background = "#3C4C55"
  vim.g.terminal_color_foreground = "#9A93E1"
end
...
vim.g.base16_colors = {
  ...
  fg            = '#C5D4DD',
  fg_gutter     = '#899BA6',
  fg_light      = '#556873',  -- TODO: this doesn't make sesne
