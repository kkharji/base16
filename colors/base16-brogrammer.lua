...
vim.g.base16_colors = {
  ...
  fg            = '#4e5ab7',
  fg_gutter     = '#1081d6',
  fg_light      = '#d6dbe5',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_1 = "#d6dbe5"
vim.g.terminal_color_2 = "#f3bd09"
vim.g.terminal_color_3 = "#1dd361"
vim.g.terminal_color_4 = "#5350b9"
vim.g.terminal_color_5 = "#0f7ddb"
vim.g.terminal_color_6 = "#1081d6"
vim.g.terminal_color_7 = "#4e5ab7"
vim.g.terminal_color_8 = "#ecba0f"
vim.g.terminal_color_9 = "#d6dbe5"
vim.g.terminal_color_10 = "#f3bd09"
vim.g.terminal_color_11 = "#1dd361"
vim.g.terminal_color_12 = "#5350b9"
vim.g.terminal_color_13 = "#0f7ddb"
vim.g.terminal_color_14 = "#1081d6"
vim.g.terminal_color_15 = "#d6dbe5"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#4e5ab7"
  vim.g.terminal_color_foreground = "#f3bd09"
else
  vim.g.terminal_color_background = "#1f1f1f"
  vim.g.terminal_color_foreground = "#0f7ddb"
end
