...
vim.g.base16_colors = {
  ...
  fg            = '#87928a',
  fg_gutter     = '#dfe7e2',
  fg_light      = '#ecf4ee',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_7 = "#87928a"
vim.g.terminal_color_8 = "#5f6d64"
...
vim.g.terminal_color_15 = "#ecf4ee"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#87928a"
  vim.g.terminal_color_foreground = "#489963"
else
  vim.g.terminal_color_background = "#171c19"
