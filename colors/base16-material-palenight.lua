...
vim.g.terminal_color_7 = "#959DCB"
vim.g.terminal_color_8 = "#676E95"
...
if vim.o.background == "light" then
  vim.g.terminal_color_background = "#959DCB"
  vim.g.terminal_color_foreground = "#C3E88D"
else
  vim.g.terminal_color_background = "#292D3E"
  vim.g.terminal_color_foreground = "#C792EA"
end
