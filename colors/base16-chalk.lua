...
vim.g.terminal_color_1 = "#fb9fb1"
vim.g.terminal_color_2 = "#acc267"
vim.g.terminal_color_3 = "#ddb26f"
vim.g.terminal_color_4 = "#6fc2ef"
vim.g.terminal_color_5 = "#e1a3ee"
vim.g.terminal_color_6 = "#12cfc0"
vim.g.terminal_color_7 = "#d0d0d0"
vim.g.terminal_color_8 = "#505050"
vim.g.terminal_color_9 = "#fb9fb1"
vim.g.terminal_color_10 = "#acc267"
vim.g.terminal_color_11 = "#ddb26f"
vim.g.terminal_color_12 = "#6fc2ef"
vim.g.terminal_color_13 = "#e1a3ee"
vim.g.terminal_color_14 = "#12cfc0"
vim.g.terminal_color_15 = "#f5f5f5"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#d0d0d0"
  vim.g.terminal_color_foreground = "#acc267"
else
  vim.g.terminal_color_background = "#151515"
  vim.g.terminal_color_foreground = "#e1a3ee"
end
...
vim.g.base16_colors = {
  ...
  fg            = '#d0d0d0',
  fg_gutter     = '#e0e0e0',
  fg_light      = '#f5f5f5',  -- TODO: this doesn't make sesne
