...
vim.g.terminal_color_1 = "#da4939"
vim.g.terminal_color_2 = "#a5c261"
vim.g.terminal_color_3 = "#ffc66d"
vim.g.terminal_color_4 = "#6d9cbe"
vim.g.terminal_color_5 = "#b6b3eb"
vim.g.terminal_color_6 = "#519f50"
vim.g.terminal_color_7 = "#e6e1dc"
vim.g.terminal_color_8 = "#5a647e"
vim.g.terminal_color_9 = "#da4939"
vim.g.terminal_color_10 = "#a5c261"
vim.g.terminal_color_11 = "#ffc66d"
vim.g.terminal_color_12 = "#6d9cbe"
vim.g.terminal_color_13 = "#b6b3eb"
vim.g.terminal_color_14 = "#519f50"
vim.g.terminal_color_15 = "#f9f7f3"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#e6e1dc"
  vim.g.terminal_color_foreground = "#a5c261"
else
  vim.g.terminal_color_background = "#2b2b2b"
  vim.g.terminal_color_foreground = "#b6b3eb"
end
...
vim.g.base16_colors = {
  ...
  fg            = '#e6e1dc',
  fg_gutter     = '#f4f1ed',
  fg_light      = '#f9f7f3',  -- TODO: this doesn't make sesne
