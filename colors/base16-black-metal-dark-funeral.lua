...
vim.g.terminal_color_2 = "#d0dfee"
vim.g.terminal_color_3 = "#5f81a5"
...
vim.g.terminal_color_10 = "#d0dfee"
vim.g.terminal_color_11 = "#5f81a5"
...
if vim.o.background == "light" then
  ...
  vim.g.terminal_color_foreground = "#d0dfee"
else
