...
vim.g.base16_colors = {
  ...
  fg            = '#b08ae6',
  fg_gutter     = '#9045e6',
  fg_light      = '#a366ff',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_1 = "#a82ee6"
vim.g.terminal_color_2 = "#4595e6"
vim.g.terminal_color_3 = "#f29df2"
vim.g.terminal_color_4 = "#4136d9"
vim.g.terminal_color_5 = "#7e5ce6"
vim.g.terminal_color_6 = "#40dfff"
vim.g.terminal_color_7 = "#b08ae6"
vim.g.terminal_color_8 = "#593380"
vim.g.terminal_color_9 = "#a82ee6"
vim.g.terminal_color_10 = "#4595e6"
vim.g.terminal_color_11 = "#f29df2"
vim.g.terminal_color_12 = "#4136d9"
vim.g.terminal_color_13 = "#7e5ce6"
vim.g.terminal_color_14 = "#40dfff"
vim.g.terminal_color_15 = "#a366ff"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#b08ae6"
  vim.g.terminal_color_foreground = "#4595e6"
else
  vim.g.terminal_color_background = "#000000"
  vim.g.terminal_color_foreground = "#7e5ce6"
end
