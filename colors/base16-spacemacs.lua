...
vim.g.terminal_color_0 = "#1f2022"
vim.g.terminal_color_1 = "#f2241f"
vim.g.terminal_color_2 = "#67b11d"
vim.g.terminal_color_3 = "#b1951d"
vim.g.terminal_color_4 = "#4f97d7"
vim.g.terminal_color_5 = "#a31db1"
vim.g.terminal_color_6 = "#2d9574"
vim.g.terminal_color_7 = "#a3a3a3"
...
vim.g.terminal_color_13 = "#a31db1"
vim.g.terminal_color_14 = "#2d9574"
vim.g.terminal_color_15 = "#f8f8f8"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#a3a3a3"
  vim.g.terminal_color_foreground = "#67b11d"
else
  vim.g.terminal_color_background = "#1f2022"
  vim.g.terminal_color_foreground = "#a31db1"
end
