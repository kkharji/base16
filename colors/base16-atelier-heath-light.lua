...
vim.g.terminal_color_7 = "#695d69"
vim.g.terminal_color_8 = "#9e8f9e"
...
vim.g.terminal_color_15 = "#1b181b"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#695d69"
  vim.g.terminal_color_foreground = "#918b3b"
else
  vim.g.terminal_color_background = "#f7f3f7"
...
vim.g.base16_colors = {
  ...
  fg            = '#695d69',
  fg_gutter     = '#292329',
  fg_light      = '#1b181b',  -- TODO: this doesn't make sesne
