...
vim.g.terminal_color_7 = "#28292a"
vim.g.terminal_color_8 = "#a3a5a6"
...
vim.g.terminal_color_15 = "#050608"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#28292a"
  vim.g.terminal_color_foreground = "#06ea61"
else
  vim.g.terminal_color_background = "#dddfe0"
...
vim.g.base16_colors = {
  ...
  fg            = '#28292a',
  fg_gutter     = '#1a1b1c',
  fg_light      = '#050608',  -- TODO: this doesn't make sesne
