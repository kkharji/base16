...
vim.g.terminal_color_0 = "#2a3b4d"
vim.g.terminal_color_1 = "#c4676c"
vim.g.terminal_color_2 = "#5de561"
vim.g.terminal_color_3 = "#cfd05d"
vim.g.terminal_color_4 = "#1ae1dc"
vim.g.terminal_color_5 = "#9c6cd3"
vim.g.terminal_color_6 = "#4b8f77"
vim.g.terminal_color_7 = "#9fa2a6"
vim.g.terminal_color_8 = "#55799c"
vim.g.terminal_color_9 = "#c4676c"
vim.g.terminal_color_10 = "#5de561"
vim.g.terminal_color_11 = "#cfd05d"
vim.g.terminal_color_12 = "#1ae1dc"
vim.g.terminal_color_13 = "#9c6cd3"
vim.g.terminal_color_14 = "#4b8f77"
vim.g.terminal_color_15 = "#ffffff"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#9fa2a6"
  vim.g.terminal_color_foreground = "#5de561"
else
  vim.g.terminal_color_background = "#2a3b4d"
  vim.g.terminal_color_foreground = "#9c6cd3"
end
