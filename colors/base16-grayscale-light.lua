...
vim.g.base16_colors = {
  ...
  fg            = '#464646',
  fg_gutter     = '#252525',
  fg_light      = '#101010',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_7 = "#464646"
vim.g.terminal_color_8 = "#ababab"
...
vim.g.terminal_color_15 = "#101010"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#464646"
  vim.g.terminal_color_foreground = "#8e8e8e"
else
  vim.g.terminal_color_background = "#f7f7f7"
  vim.g.terminal_color_foreground = "#747474"
end
