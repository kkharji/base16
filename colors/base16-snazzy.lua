...
vim.g.terminal_color_7 = "#e2e4e5"
vim.g.terminal_color_8 = "#78787e"
...
vim.g.terminal_color_15 = "#f1f1f0"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#e2e4e5"
  vim.g.terminal_color_foreground = "#5af78e"
else
  vim.g.terminal_color_background = "#282a36"
  vim.g.terminal_color_foreground = "#ff6ac1"
end
...
vim.g.base16_colors = {
  ...
  fg            = '#e2e4e5',
  fg_gutter     = '#eff0eb',
  fg_light      = '#f1f1f0',  -- TODO: this doesn't make sesne
