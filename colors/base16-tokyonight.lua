...
--- Set color name
vim.g.colors_name ='base16-tokyonight'
...
if vim.o.background == "light" then
  vim.g.terminal_color_background = "#a9b1d6"
  vim.g.terminal_color_foreground = "#9ece6a"
else
  vim.g.terminal_color_background = "#1a1b26"
  vim.g.terminal_color_foreground = "#bb9af7"
end
...
vim.g.base16_colors = {
  ...
  fg            = '#a9b1d6',
  fg_gutter     = '#c0c0c0',
  fg_light      = '#c0caf5',  -- TODO: this doesn't make sesne
