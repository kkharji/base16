...
vim.g.base16_colors = {
  ...
  fg            = '#5e6687',
  fg_gutter     = '#293256',
  fg_light      = '#202746',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_7 = "#5e6687"
vim.g.terminal_color_8 = "#898ea4"
...
vim.g.terminal_color_15 = "#202746"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#5e6687"
  vim.g.terminal_color_foreground = "#ac9739"
else
  vim.g.terminal_color_background = "#f5f7ff"
