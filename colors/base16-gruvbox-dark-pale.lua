...
vim.g.terminal_color_2 = "#afaf00"
vim.g.terminal_color_3 = "#ffaf00"
vim.g.terminal_color_4 = "#83adad"
vim.g.terminal_color_5 = "#d485ad"
vim.g.terminal_color_6 = "#85ad85"
vim.g.terminal_color_7 = "#dab997"
vim.g.terminal_color_8 = "#8a8a8a"
vim.g.terminal_color_9 = "#d75f5f"
vim.g.terminal_color_10 = "#afaf00"
vim.g.terminal_color_11 = "#ffaf00"
vim.g.terminal_color_12 = "#83adad"
vim.g.terminal_color_13 = "#d485ad"
vim.g.terminal_color_14 = "#85ad85"
vim.g.terminal_color_15 = "#ebdbb2"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#dab997"
  vim.g.terminal_color_foreground = "#afaf00"
else
  vim.g.terminal_color_background = "#262626"
  vim.g.terminal_color_foreground = "#d485ad"
end
...
vim.g.base16_colors = {
  ...
  fg            = '#dab997',
  fg_gutter     = '#d5c4a1',
  fg_light      = '#ebdbb2',  -- TODO: this doesn't make sesne
