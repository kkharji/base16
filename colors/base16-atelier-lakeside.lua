...
vim.g.base16_colors = {
  ...
  fg            = '#7ea2b4',
  fg_gutter     = '#c1e4f6',
  fg_light      = '#ebf8ff',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_7 = "#7ea2b4"
vim.g.terminal_color_8 = "#5a7b8c"
...
vim.g.terminal_color_15 = "#ebf8ff"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#7ea2b4"
  vim.g.terminal_color_foreground = "#568c3b"
else
  vim.g.terminal_color_background = "#161b1d"
