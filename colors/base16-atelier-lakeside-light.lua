...
vim.g.base16_colors = {
  ...
  fg            = '#516d7b',
  fg_gutter     = '#1f292e',
  fg_light      = '#161b1d',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_0 = "#ebf8ff"
vim.g.terminal_color_1 = "#d22d72"
vim.g.terminal_color_2 = "#568c3b"
vim.g.terminal_color_3 = "#8a8a0f"
vim.g.terminal_color_4 = "#257fad"
vim.g.terminal_color_5 = "#6b6bb8"
vim.g.terminal_color_6 = "#2d8f6f"
vim.g.terminal_color_7 = "#516d7b"
vim.g.terminal_color_8 = "#7195a8"
vim.g.terminal_color_9 = "#d22d72"
vim.g.terminal_color_10 = "#568c3b"
vim.g.terminal_color_11 = "#8a8a0f"
vim.g.terminal_color_12 = "#257fad"
vim.g.terminal_color_13 = "#6b6bb8"
vim.g.terminal_color_14 = "#2d8f6f"
vim.g.terminal_color_15 = "#161b1d"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#516d7b"
  vim.g.terminal_color_foreground = "#568c3b"
else
  vim.g.terminal_color_background = "#ebf8ff"
  vim.g.terminal_color_foreground = "#6b6bb8"
end
