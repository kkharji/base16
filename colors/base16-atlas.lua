...
vim.g.base16_colors = {
  ...
  fg            = '#a1a19a',
  fg_gutter     = '#e6e6dc',
  fg_light      = '#fafaf8',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_0 = "#002635"
vim.g.terminal_color_1 = "#ff5a67"
vim.g.terminal_color_2 = "#7fc06e"
vim.g.terminal_color_3 = "#ffcc1b"
vim.g.terminal_color_4 = "#5dd7b9"
vim.g.terminal_color_5 = "#9a70a4"
vim.g.terminal_color_6 = "#14747e"
vim.g.terminal_color_7 = "#a1a19a"
vim.g.terminal_color_8 = "#6C8B91"
vim.g.terminal_color_9 = "#ff5a67"
vim.g.terminal_color_10 = "#7fc06e"
vim.g.terminal_color_11 = "#ffcc1b"
vim.g.terminal_color_12 = "#5dd7b9"
vim.g.terminal_color_13 = "#9a70a4"
vim.g.terminal_color_14 = "#14747e"
vim.g.terminal_color_15 = "#fafaf8"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#a1a19a"
  vim.g.terminal_color_foreground = "#7fc06e"
else
  vim.g.terminal_color_background = "#002635"
  vim.g.terminal_color_foreground = "#9a70a4"
end
