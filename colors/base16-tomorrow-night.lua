...
vim.g.terminal_color_10 = "#b5bd68"
vim.g.terminal_color_11 = "#f0c674"
vim.g.terminal_color_12 = "#81a2be"
vim.g.terminal_color_13 = "#b294bb"
vim.g.terminal_color_14 = "#8abeb7"
vim.g.terminal_color_15 = "#ffffff"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#c5c8c6"
  vim.g.terminal_color_foreground = "#b5bd68"
else
  vim.g.terminal_color_background = "#1d1f21"
  vim.g.terminal_color_foreground = "#b294bb"
end
