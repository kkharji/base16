...
vim.g.terminal_color_0 = "#202126"
vim.g.terminal_color_1 = "#ff661a"
vim.g.terminal_color_2 = "#f2e6a9"
vim.g.terminal_color_3 = "#ffdc2d"
vim.g.terminal_color_4 = "#40bfff"
vim.g.terminal_color_5 = "#ae94f9"
vim.g.terminal_color_6 = "#fb6acb"
vim.g.terminal_color_7 = "#e9e7e1"
vim.g.terminal_color_8 = "#a1d2e6"
vim.g.terminal_color_9 = "#ff661a"
vim.g.terminal_color_10 = "#f2e6a9"
vim.g.terminal_color_11 = "#ffdc2d"
vim.g.terminal_color_12 = "#40bfff"
vim.g.terminal_color_13 = "#ae94f9"
vim.g.terminal_color_14 = "#fb6acb"
vim.g.terminal_color_15 = "#f2fbff"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#e9e7e1"
  vim.g.terminal_color_foreground = "#f2e6a9"
else
  vim.g.terminal_color_background = "#202126"
  vim.g.terminal_color_foreground = "#ae94f9"
end
...
vim.g.base16_colors = {
  ...
  fg            = '#e9e7e1',
  fg_gutter     = '#eff0f9',
  fg_light      = '#f2fbff',  -- TODO: this doesn't make sesne
