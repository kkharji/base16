...
vim.g.terminal_color_7 = "#405c79"
vim.g.terminal_color_8 = "#aabcce"
...
vim.g.terminal_color_15 = "#0b1c2c"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#405c79"
  vim.g.terminal_color_foreground = "#56bf8b"
else
  vim.g.terminal_color_background = "#f7f9fb"
...
vim.g.base16_colors = {
  ...
  fg            = '#405c79',
  fg_gutter     = '#223b54',
  fg_light      = '#0b1c2c',  -- TODO: this doesn't make sesne
