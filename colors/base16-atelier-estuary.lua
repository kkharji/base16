...
vim.g.base16_colors = {
  ...
  fg            = '#929181',
  fg_gutter     = '#e7e6df',
  fg_light      = '#f4f3ec',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_7 = "#929181"
vim.g.terminal_color_8 = "#6c6b5a"
...
vim.g.terminal_color_15 = "#f4f3ec"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#929181"
  vim.g.terminal_color_foreground = "#7d9726"
else
  vim.g.terminal_color_background = "#22221b"
