...
vim.g.terminal_color_1 = "#d72638"
vim.g.terminal_color_2 = "#88b92d"
vim.g.terminal_color_3 = "#f19d1a"
vim.g.terminal_color_4 = "#1e8bac"
vim.g.terminal_color_5 = "#be4264"
vim.g.terminal_color_6 = "#1ba595"
vim.g.terminal_color_7 = "#d5d5d5"
vim.g.terminal_color_8 = "#6f7579"
vim.g.terminal_color_9 = "#d72638"
vim.g.terminal_color_10 = "#88b92d"
vim.g.terminal_color_11 = "#f19d1a"
vim.g.terminal_color_12 = "#1e8bac"
vim.g.terminal_color_13 = "#be4264"
vim.g.terminal_color_14 = "#1ba595"
vim.g.terminal_color_15 = "#e5e5e5"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#d5d5d5"
  vim.g.terminal_color_foreground = "#88b92d"
else
  vim.g.terminal_color_background = "#1d2021"
  vim.g.terminal_color_foreground = "#be4264"
end
...
vim.g.base16_colors = {
  ...
  fg            = '#d5d5d5',
  fg_gutter     = '#dddddd',
  fg_light      = '#e5e5e5',  -- TODO: this doesn't make sesne
