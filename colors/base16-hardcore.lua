...
vim.g.terminal_color_5 = "#9e6ffe"
vim.g.terminal_color_6 = "#708387"
...
vim.g.terminal_color_13 = "#9e6ffe"
vim.g.terminal_color_14 = "#708387"
vim.g.terminal_color_15 = "#ffffff"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#cdcdcd"
  vim.g.terminal_color_foreground = "#a6e22e"
else
  vim.g.terminal_color_background = "#212121"
  vim.g.terminal_color_foreground = "#9e6ffe"
end
