...
vim.g.terminal_color_7 = "#586e75"
vim.g.terminal_color_8 = "#839496"
...
vim.g.terminal_color_15 = "#002b36"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#586e75"
  vim.g.terminal_color_foreground = "#859900"
else
  vim.g.terminal_color_background = "#fdf6e3"
...
vim.g.base16_colors = {
  ...
  fg            = '#586e75',
  fg_gutter     = '#073642',
  fg_light      = '#002b36',  -- TODO: this doesn't make sesne
