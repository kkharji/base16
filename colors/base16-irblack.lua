...
vim.g.base16_colors = {
  ...
  fg            = '#b5b3aa',
  fg_gutter     = '#d9d7cc',
  fg_light      = '#fdfbee',  -- TODO: this doesn't make sesne
...
if vim.o.background == "light" then
  vim.g.terminal_color_background = "#b5b3aa"
  vim.g.terminal_color_foreground = "#a8ff60"
else
  vim.g.terminal_color_background = "#000000"
  vim.g.terminal_color_foreground = "#ff73fd"
end
