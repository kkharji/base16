...
vim.g.base16_colors = {
  ...
  fg            = '#B0C5C8',
  fg_gutter     = '#C9DBDC',
  fg_light      = '#E3EFEF',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_7 = "#B0C5C8"
vim.g.terminal_color_8 = "#8299A1"
...
vim.g.terminal_color_15 = "#E3EFEF"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#B0C5C8"
  vim.g.terminal_color_foreground = "#87b386"
else
  vim.g.terminal_color_background = "#485867"
