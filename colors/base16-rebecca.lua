...
vim.g.terminal_color_0 = "#292a44"
vim.g.terminal_color_1 = "#a0a0c5"
vim.g.terminal_color_2 = "#6dfedf"
vim.g.terminal_color_3 = "#ae81ff"
vim.g.terminal_color_4 = "#2de0a7"
vim.g.terminal_color_5 = "#7aa5ff"
vim.g.terminal_color_6 = "#8eaee0"
vim.g.terminal_color_7 = "#f1eff8"
vim.g.terminal_color_8 = "#666699"
vim.g.terminal_color_9 = "#a0a0c5"
vim.g.terminal_color_10 = "#6dfedf"
vim.g.terminal_color_11 = "#ae81ff"
vim.g.terminal_color_12 = "#2de0a7"
vim.g.terminal_color_13 = "#7aa5ff"
vim.g.terminal_color_14 = "#8eaee0"
vim.g.terminal_color_15 = "#53495d"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#f1eff8"
  vim.g.terminal_color_foreground = "#6dfedf"
else
  vim.g.terminal_color_background = "#292a44"
  vim.g.terminal_color_foreground = "#7aa5ff"
end
...
vim.g.base16_colors = {
  ...
  fg            = '#f1eff8',
  fg_gutter     = '#ccccff',
  fg_light      = '#53495d',  -- TODO: this doesn't make sesne
