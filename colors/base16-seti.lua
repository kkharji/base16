...
vim.g.terminal_color_2 = "#9fca56"
vim.g.terminal_color_3 = "#e6cd69"
vim.g.terminal_color_4 = "#55b5db"
vim.g.terminal_color_5 = "#a074c4"
vim.g.terminal_color_6 = "#55dbbe"
vim.g.terminal_color_7 = "#d6d6d6"
vim.g.terminal_color_8 = "#41535B"
vim.g.terminal_color_9 = "#Cd3f45"
vim.g.terminal_color_10 = "#9fca56"
vim.g.terminal_color_11 = "#e6cd69"
vim.g.terminal_color_12 = "#55b5db"
vim.g.terminal_color_13 = "#a074c4"
vim.g.terminal_color_14 = "#55dbbe"
vim.g.terminal_color_15 = "#ffffff"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#d6d6d6"
  vim.g.terminal_color_foreground = "#9fca56"
else
