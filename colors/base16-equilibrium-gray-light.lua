...
vim.g.terminal_color_15 = "#1b1b1b"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#474747"
  vim.g.terminal_color_foreground = "#637200"
else
  vim.g.terminal_color_background = "#f1f1f1"
...
vim.g.base16_colors = {
  ...
  fg            = '#474747',
  fg_gutter     = '#303030',
  fg_light      = '#1b1b1b',  -- TODO: this doesn't make sesne
