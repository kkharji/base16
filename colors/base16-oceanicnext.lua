...
vim.g.terminal_color_15 = "#D8DEE9"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#C0C5CE"
  vim.g.terminal_color_foreground = "#99C794"
else
  vim.g.terminal_color_background = "#1B2B34"
  vim.g.terminal_color_foreground = "#C594C5"
end
