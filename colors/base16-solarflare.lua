...
vim.g.terminal_color_7 = "#A6AFB8"
vim.g.terminal_color_8 = "#667581"
...
if vim.o.background == "light" then
  vim.g.terminal_color_background = "#A6AFB8"
  vim.g.terminal_color_foreground = "#7CC844"
else
  vim.g.terminal_color_background = "#18262F"
...
vim.g.base16_colors = {
  ...
  fg            = '#A6AFB8',
  fg_gutter     = '#E8E9ED',
  fg_light      = '#F5F7FA',  -- TODO: this doesn't make sesne
