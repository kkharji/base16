...
vim.g.terminal_color_15 = "#e2e2e2"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#ababab"
  vim.g.terminal_color_foreground = "#7f8b00"
else
  vim.g.terminal_color_background = "#111111"
...
vim.g.base16_colors = {
  ...
  fg            = '#ababab',
  fg_gutter     = '#c6c6c6',
  fg_light      = '#e2e2e2',  -- TODO: this doesn't make sesne
