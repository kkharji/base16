...
vim.g.terminal_color_2 = "#ddeecc"
vim.g.terminal_color_3 = "#99bbaa"
...
vim.g.terminal_color_10 = "#ddeecc"
vim.g.terminal_color_11 = "#99bbaa"
...
if vim.o.background == "light" then
  ...
  vim.g.terminal_color_foreground = "#ddeecc"
else
