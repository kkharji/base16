...
vim.g.base16_colors = {
  ...
  fg            = '#abb2bf',
  fg_gutter     = '#b6bdca',
  fg_light      = '#c8ccd4',  -- TODO: this doesn't make sesne
...
if vim.o.background == "light" then
  vim.g.terminal_color_background = "#abb2bf"
  vim.g.terminal_color_foreground = "#98c379"
else
  vim.g.terminal_color_background = "#282c34"
  vim.g.terminal_color_foreground = "#c678dd"
end
