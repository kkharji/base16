...
vim.g.terminal_color_0 = "#191724"
vim.g.terminal_color_1 = "#e2e1e7"
vim.g.terminal_color_2 = "#ebbcba"
vim.g.terminal_color_3 = "#f6c177"
vim.g.terminal_color_4 = "#9ccfd8"
vim.g.terminal_color_5 = "#c4a7e7"
vim.g.terminal_color_6 = "#31748f"
vim.g.terminal_color_7 = "#e0def4"
vim.g.terminal_color_8 = "#555169"
vim.g.terminal_color_9 = "#e2e1e7"
vim.g.terminal_color_10 = "#ebbcba"
vim.g.terminal_color_11 = "#f6c177"
vim.g.terminal_color_12 = "#9ccfd8"
vim.g.terminal_color_13 = "#c4a7e7"
vim.g.terminal_color_14 = "#31748f"
vim.g.terminal_color_15 = "#c5c3ce"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#e0def4"
  vim.g.terminal_color_foreground = "#ebbcba"
else
  vim.g.terminal_color_background = "#191724"
  vim.g.terminal_color_foreground = "#c4a7e7"
end
...
vim.g.base16_colors = {
  ...
  fg            = '#e0def4',
  fg_gutter     = '#f0f0f3',
  fg_light      = '#c5c3ce',  -- TODO: this doesn't make sesne
