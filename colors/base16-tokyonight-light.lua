...
--- Set color name
vim.g.colors_name ='base16-tokyonight-light'
...
vim.g.terminal_color_7 = "#6172b0"
vim.g.terminal_color_8 = "#a1a6c5"
...
if vim.o.background == "light" then
  vim.g.terminal_color_background = "#6172b0"
  vim.g.terminal_color_foreground = "#587539"
else
  vim.g.terminal_color_background = "#e1e2e7"
  vim.g.terminal_color_foreground = "#9854f1"
end
...
vim.g.base16_colors = {
  ...
  fg            = '#6172b0',
  fg_gutter     = '#c0c0c0',
  fg_light      = '#3760bf',  -- TODO: this doesn't make sesne
