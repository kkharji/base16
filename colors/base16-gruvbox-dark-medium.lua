...
if vim.o.background == "light" then
  vim.g.terminal_color_background = "#d5c4a1"
  vim.g.terminal_color_foreground = "#b8bb26"
else
  vim.g.terminal_color_background = "#282828"
  vim.g.terminal_color_foreground = "#d3869b"
end
...
vim.g.base16_colors = {
  ...
  fg            = '#d5c4a1',
  fg_gutter     = '#ebdbb2',
  fg_light      = '#fbf1c7',  -- TODO: this doesn't make sesne
