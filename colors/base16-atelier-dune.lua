...
vim.g.base16_colors = {
  ...
  fg            = '#a6a28c',
  fg_gutter     = '#e8e4cf',
  fg_light      = '#fefbec',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_7 = "#a6a28c"
vim.g.terminal_color_8 = "#7d7a68"
...
vim.g.terminal_color_15 = "#fefbec"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#a6a28c"
  vim.g.terminal_color_foreground = "#60ac39"
else
  vim.g.terminal_color_background = "#20201d"
