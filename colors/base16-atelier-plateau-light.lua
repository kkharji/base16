...
vim.g.terminal_color_7 = "#585050"
vim.g.terminal_color_8 = "#7e7777"
...
vim.g.terminal_color_15 = "#1b1818"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#585050"
  vim.g.terminal_color_foreground = "#4b8b8b"
else
  vim.g.terminal_color_background = "#f4ecec"
...
vim.g.base16_colors = {
  ...
  fg            = '#585050',
  fg_gutter     = '#292424',
  fg_light      = '#1b1818',  -- TODO: this doesn't make sesne
