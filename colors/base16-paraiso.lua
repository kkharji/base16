...
vim.g.terminal_color_0 = "#2f1e2e"
vim.g.terminal_color_1 = "#ef6155"
vim.g.terminal_color_2 = "#48b685"
vim.g.terminal_color_3 = "#fec418"
vim.g.terminal_color_4 = "#06b6ef"
vim.g.terminal_color_5 = "#815ba4"
vim.g.terminal_color_6 = "#5bc4bf"
vim.g.terminal_color_7 = "#a39e9b"
vim.g.terminal_color_8 = "#776e71"
vim.g.terminal_color_9 = "#ef6155"
vim.g.terminal_color_10 = "#48b685"
vim.g.terminal_color_11 = "#fec418"
vim.g.terminal_color_12 = "#06b6ef"
vim.g.terminal_color_13 = "#815ba4"
vim.g.terminal_color_14 = "#5bc4bf"
vim.g.terminal_color_15 = "#e7e9db"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#a39e9b"
  vim.g.terminal_color_foreground = "#48b685"
else
  vim.g.terminal_color_background = "#2f1e2e"
  vim.g.terminal_color_foreground = "#815ba4"
end
...
vim.g.base16_colors = {
  ...
  fg            = '#a39e9b',
  fg_gutter     = '#b9b6b0',
  fg_light      = '#e7e9db',  -- TODO: this doesn't make sesne
