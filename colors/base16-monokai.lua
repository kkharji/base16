...
vim.g.terminal_color_15 = "#f9f8f5"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#f8f8f2"
  vim.g.terminal_color_foreground = "#a6e22e"
else
  vim.g.terminal_color_background = "#272822"
  vim.g.terminal_color_foreground = "#ae81ff"
end
...
vim.g.base16_colors = {
  ...
  fg            = '#f8f8f2',
  fg_gutter     = '#f5f4f1',
  fg_light      = '#f9f8f5',  -- TODO: this doesn't make sesne
