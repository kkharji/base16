...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 selenized-dark 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-selenized-dark-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#103c48', '#fa5750', '#75b938', '#dbb32d', '#4695f7', '#af88eb', '#41c7b9', '#adbcbc', '#72898f', '#fa5750', '#75b938', '#dbb32d', '#4695f7', '#af88eb', '#41c7b9', '#cad8d9']"
