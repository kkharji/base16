...
vim.g.base16_colors = {
  ...
  fg            = '#d3d7cf',
  fg_gutter     = '#ad7fa8',
  fg_light      = '#eeeeec',  -- TODO: this doesn't make sesne
...
if vim.o.background == "light" then
  vim.g.terminal_color_background = "#d3d7cf"
  vim.g.terminal_color_foreground = "#4e9a06"
else
  vim.g.terminal_color_background = "#2e3436"
  vim.g.terminal_color_foreground = "#75507b"
end
