...
vim.g.base16_colors = {
  ...
  fg            = '#5e6e5e',
  fg_gutter     = '#242924',
  fg_light      = '#131513',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_7 = "#5e6e5e"
vim.g.terminal_color_8 = "#809980"
...
vim.g.terminal_color_15 = "#131513"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#5e6e5e"
  vim.g.terminal_color_foreground = "#29a329"
else
  vim.g.terminal_color_background = "#f4fbf4"
