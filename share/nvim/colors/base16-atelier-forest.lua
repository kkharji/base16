...
vim.g.base16_colors = {
  ...
  fg            = '#a8a19f',
  fg_gutter     = '#e6e2e0',
  fg_light      = '#f1efee',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_15 = "#f1efee"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#a8a19f"
  vim.g.terminal_color_foreground = "#7b9726"
else
  vim.g.terminal_color_background = "#1b1918"
