...
vim.g.terminal_color_2 = "#f3ecd4"
vim.g.terminal_color_3 = "#eecc6c"
...
vim.g.terminal_color_10 = "#f3ecd4"
vim.g.terminal_color_11 = "#eecc6c"
...
if vim.o.background == "light" then
  ...
  vim.g.terminal_color_foreground = "#f3ecd4"
else
