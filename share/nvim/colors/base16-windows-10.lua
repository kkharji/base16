...
vim.g.base16_colors = {
  ...
  fg            = '#cccccc',
  fg_gutter     = '#dfdfdf',
  fg_light      = '#f2f2f2',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_2 = "#16c60c"
vim.g.terminal_color_3 = "#f9f1a5"
vim.g.terminal_color_4 = "#3b78ff"
vim.g.terminal_color_5 = "#b4009e"
vim.g.terminal_color_6 = "#61d6d6"
...
if vim.o.background == "light" then
  ...
  vim.g.terminal_color_foreground = "#16c60c"
else
  vim.g.terminal_color_background = "#0c0c0c"
  vim.g.terminal_color_foreground = "#b4009e"
end
