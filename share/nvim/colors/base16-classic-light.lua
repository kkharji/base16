...
vim.g.base16_colors = {
  ...
  fg            = '#303030',
  fg_gutter     = '#202020',
  fg_light      = '#151515',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_15 = "#151515"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#303030"
  vim.g.terminal_color_foreground = "#90A959"
else
  vim.g.terminal_color_background = "#F5F5F5"
  vim.g.terminal_color_foreground = "#AA759F"
end
