...
vim.g.base16_colors = {
  ...
  fg            = '#e0f0eF',
  fg_gutter     = '#ecf6f2',
  fg_light      = '#fcfefd',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_0 = "#2d302f"
vim.g.terminal_color_1 = "#F9906F"
vim.g.terminal_color_2 = "#8AB361"
vim.g.terminal_color_3 = "#F0C239"
vim.g.terminal_color_4 = "#B0A4E3"
vim.g.terminal_color_5 = "#CCA4E3"
vim.g.terminal_color_6 = "#30DFF3"
vim.g.terminal_color_7 = "#e0f0eF"
vim.g.terminal_color_8 = "#9da8a3"
vim.g.terminal_color_9 = "#F9906F"
vim.g.terminal_color_10 = "#8AB361"
vim.g.terminal_color_11 = "#F0C239"
vim.g.terminal_color_12 = "#B0A4E3"
vim.g.terminal_color_13 = "#CCA4E3"
vim.g.terminal_color_14 = "#30DFF3"
vim.g.terminal_color_15 = "#fcfefd"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#e0f0eF"
  vim.g.terminal_color_foreground = "#8AB361"
else
  vim.g.terminal_color_background = "#2d302f"
  vim.g.terminal_color_foreground = "#CCA4E3"
end
