...
vim.g.base16_colors = {
  ...
  fg            = '#5a605d',
  fg_gutter     = '#434846',
  fg_light      = '#2d302f',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_7 = "#5a605d"
vim.g.terminal_color_8 = "#cad8d2"
...
vim.g.terminal_color_15 = "#2d302f"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#5a605d"
  vim.g.terminal_color_foreground = "#8AB361"
else
  vim.g.terminal_color_background = "#fcfefd"
