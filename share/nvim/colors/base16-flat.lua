...
vim.g.base16_colors = {
  ...
  fg            = '#e0e0e0',
  fg_gutter     = '#f5f5f5',
  fg_light      = '#ECF0F1',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_0 = "#2C3E50"
vim.g.terminal_color_1 = "#E74C3C"
vim.g.terminal_color_2 = "#2ECC71"
...
vim.g.terminal_color_8 = "#95A5A6"
vim.g.terminal_color_9 = "#E74C3C"
vim.g.terminal_color_10 = "#2ECC71"
vim.g.terminal_color_11 = "#F1C40F"
vim.g.terminal_color_12 = "#3498DB"
vim.g.terminal_color_13 = "#9B59B6"
vim.g.terminal_color_14 = "#1ABC9C"
vim.g.terminal_color_15 = "#ECF0F1"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#e0e0e0"
  vim.g.terminal_color_foreground = "#2ECC71"
else
  vim.g.terminal_color_background = "#2C3E50"
  vim.g.terminal_color_foreground = "#9B59B6"
end
