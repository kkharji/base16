...
vim.g.base16_colors = {
  ...
  fg            = '#a4a6a9',
  fg_gutter     = '#c7c9cd',
  fg_light      = '#8dbdaa',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_0 = "#22273b"
vim.g.terminal_color_1 = "#777abc"
vim.g.terminal_color_2 = "#6562a8"
vim.g.terminal_color_3 = "#4f9062"
vim.g.terminal_color_4 = "#4d6bb6"
vim.g.terminal_color_5 = "#716cae"
vim.g.terminal_color_6 = "#226f68"
vim.g.terminal_color_7 = "#a4a6a9"
vim.g.terminal_color_8 = "#6e6f72"
vim.g.terminal_color_9 = "#777abc"
vim.g.terminal_color_10 = "#6562a8"
vim.g.terminal_color_11 = "#4f9062"
vim.g.terminal_color_12 = "#4d6bb6"
vim.g.terminal_color_13 = "#716cae"
vim.g.terminal_color_14 = "#226f68"
vim.g.terminal_color_15 = "#8dbdaa"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#a4a6a9"
  vim.g.terminal_color_foreground = "#6562a8"
else
  vim.g.terminal_color_background = "#22273b"
  vim.g.terminal_color_foreground = "#716cae"
end
