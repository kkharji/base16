...
vim.g.base16_colors = {
  ...
  fg            = '#a5a2a2',
  fg_gutter     = '#d6d5d4',
  fg_light      = '#f7f7f7',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_1 = "#db2d20"
vim.g.terminal_color_2 = "#01a252"
vim.g.terminal_color_3 = "#fded02"
vim.g.terminal_color_4 = "#01a0e4"
vim.g.terminal_color_5 = "#a16a94"
vim.g.terminal_color_6 = "#b5e4f4"
vim.g.terminal_color_7 = "#a5a2a2"
vim.g.terminal_color_8 = "#5c5855"
vim.g.terminal_color_9 = "#db2d20"
vim.g.terminal_color_10 = "#01a252"
vim.g.terminal_color_11 = "#fded02"
vim.g.terminal_color_12 = "#01a0e4"
vim.g.terminal_color_13 = "#a16a94"
vim.g.terminal_color_14 = "#b5e4f4"
vim.g.terminal_color_15 = "#f7f7f7"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#a5a2a2"
  vim.g.terminal_color_foreground = "#01a252"
else
  vim.g.terminal_color_background = "#090300"
  vim.g.terminal_color_foreground = "#a16a94"
end
