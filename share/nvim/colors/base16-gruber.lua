...
vim.g.base16_colors = {
  ...
  fg            = '#f4f4ff',
  fg_gutter     = '#f5f5f5',
  fg_light      = '#e4e4ef',  -- TODO: this doesn't make sesne
...
vim.g.terminal_color_1 = "#f43841"
vim.g.terminal_color_2 = "#73c936"
vim.g.terminal_color_3 = "#ffdd33"
vim.g.terminal_color_4 = "#96a6c8"
vim.g.terminal_color_5 = "#9e95c7"
vim.g.terminal_color_6 = "#95a99f"
vim.g.terminal_color_7 = "#f4f4ff"
vim.g.terminal_color_8 = "#9dae93"
vim.g.terminal_color_9 = "#f43841"
vim.g.terminal_color_10 = "#73c936"
vim.g.terminal_color_11 = "#ffdd33"
vim.g.terminal_color_12 = "#96a6c8"
vim.g.terminal_color_13 = "#9e95c7"
vim.g.terminal_color_14 = "#95a99f"
vim.g.terminal_color_15 = "#e4e4ef"

if vim.o.background == "light" then
  vim.g.terminal_color_background = "#f4f4ff"
  vim.g.terminal_color_foreground = "#73c936"
else
  vim.g.terminal_color_background = "#181818"
  vim.g.terminal_color_foreground = "#9e95c7"
end
